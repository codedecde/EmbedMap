...
class TheanoBackend(Backend):
    ...
    def compile_function(self, objective, argument):
        ...
        """
        try:
            return theano.function([argument], objective, allow_input_downcast=True)
        except TypeError:
            # Assume we are on a product manifold
            compiled = theano.function([arg for arg in argument], objective, allow_input_downcast=True)
    ...
    def compute_hessian(self, objective, argument):
        ...
        try:
            hess = theano.function([argument, A], R, on_unused_input="warn", allow_input_downcast=True)
        except TypeError:
